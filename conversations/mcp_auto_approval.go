...
// When the wrapper auto-executes tools, it sets ALL of them to either
// ToolCallStatusAutoApproved or ToolCallStatusError — so if any has
// AutoApproved status, the entire batch went through auto-approval.
