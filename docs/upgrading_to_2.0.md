...
5. **Verify your license is current.** Multi-agent configurations and fine-grained access controls require a Professional, Entry, Enterprise, or Enterprise Advanced license; MCP support and embedding search require an Entry, Enterprise, or Enterprise Advanced license. See [License requirements](admin_guide.md#license-requirements).
