...
type CompletionRequest struct {
	...
	// UseAgentSystemPrompt prepends the targeted agent's configured system prompt
	// before the supplied posts. It is supported only on agent completion endpoints.
