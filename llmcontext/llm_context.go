...
type MCPToolProvider interface {
	GetToolsForUser(userID string, isAutomatedInvoker bool) ([]llm.Tool, *mcp.Errors)
}
...
func (b *Builder) getToolsStoreForUser(c *llm.Context, bot *bots.Bot, userID string) *llm.ToolStore {
	...
	if b.mcpToolProvider != nil {
		...
		mcpTools, mcpErrors := b.mcpToolProvider.GetToolsForUser(userID, c.AutomatedMCPInvoker)
