...
func (p *Plugin) OnActivate() error {
	...
	currentCfg, changed, err := runAllMigrations(p.API, pluginAPI, *p.configuration.Config())
	if err != nil {
		...
		p.configuration.Update(&currentCfg)
	...
	if ensureBotsErr := bots.EnsureBots(currentCfg.Bots); ensureBotsErr != nil {
