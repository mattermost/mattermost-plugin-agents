...
// GetChannelStats provides a mock function for the type MockClient
func (_mock *MockClient) GetChannelStats(channelID string) (*model.ChannelStats, error) {
	ret := _mock.Called(channelID)
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(string) (*model.ChannelStats, error)); ok {
		return returnFunc(channelID)
	}
	if returnFunc, ok := ret.Get(0).(func(string) *model.ChannelStats); ok {
		r0 = returnFunc(channelID)
	} else {
		if ret.Get(0) != nil {
...
// MockClient_GetChannelStats_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetChannelStats'
type MockClient_GetChannelStats_Call struct {
	*mock.Call
}

// GetChannelStats is a helper method to define mock.On call
//   - channelID
func (_e *MockClient_Expecter) GetChannelStats(channelID interface{}) *MockClient_GetChannelStats_Call {
	return &MockClient_GetChannelStats_Call{Call: _e.mock.On("GetChannelStats", channelID)}
}

func (_c *MockClient_GetChannelStats_Call) Run(run func(channelID string)) *MockClient_GetChannelStats_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockClient_GetChannelStats_Call) Return(channelStats *model.ChannelStats, err error) *MockClient_GetChannelStats_Call {
	_c.Call.Return(channelStats, err)
	return _c
}

func (_c *MockClient_GetChannelStats_Call) RunAndReturn(run func(channelID string) (*model.ChannelStats, error)) *MockClient_GetChannelStats_Call {
	_c.Call.Return(run)
	return _c
}
