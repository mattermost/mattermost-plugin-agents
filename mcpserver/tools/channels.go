	...
	return []MCPTool{
		{
			...
			Schema:      AnnotateMattermostScopeTags[ReadChannelArgs](llm.NewJSONSchemaFromStruct[ReadChannelArgs]()),
		...
		},
		{
			...
			Schema:      AnnotateMattermostScopeTags[CreateChannelArgs](llm.NewJSONSchemaFromStruct[CreateChannelArgs]()),
		...
		},
		{
			...
			Schema:      AnnotateMattermostScopeTags[GetChannelInfoArgs](llm.NewJSONSchemaFromStruct[GetChannelInfoArgs]()),
		...
		},
		{
			...
			Schema:      AnnotateMattermostScopeTags[GetChannelMembersArgs](llm.NewJSONSchemaFromStruct[GetChannelMembersArgs]()),
		...
		},
		{
			...
			Schema:      AnnotateMattermostScopeTags[AddUserToChannelArgs](llm.NewJSONSchemaFromStruct[AddUserToChannelArgs]()),
		...
		},
		{
			...
			Schema:      AnnotateMattermostScopeTags[GetUserChannelsArgs](llm.NewJSONSchemaFromStruct[GetUserChannelsArgs]()),
