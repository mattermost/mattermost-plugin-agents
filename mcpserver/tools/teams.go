...
func (p *MattermostToolProvider) getTeamTools() []MCPTool {
	return []MCPTool{
		mcpReadTool(p, "get_team_info", getTeamInfoDescription, p.toolGetTeamInfo),
		mcpReadTool(p, "get_team_members", getTeamMembersDescription, p.toolGetTeamMembers),
		...
		mcpReadTool(p, "get_team_member", getTeamMemberDescription, p.toolGetTeamMember),
		mcpReadTool(p, "get_team_stats", getTeamStatsDescription, p.toolGetTeamStats),
		mcpReadTool(p, "get_user_teams", getUserTeamsDescription, p.toolGetUserTeams),
		mcpReadTool(p, "get_users_in_team", getUsersInTeamDescription, p.toolGetUsersInTeam),
		mcpReadTool(p, "get_users_not_in_team", getUsersNotInTeamDescription, p.toolGetUsersNotInTeam),
		mcpReadTool(p, "get_new_users_in_team", getNewUsersInTeamDescription, p.toolGetNewUsersInTeam),
		mcpReadTool(p, "get_dm_common_teams", getDMCommonTeamsDescription, p.toolGetDMCommonTeams),
		mcpReadTool(p, "search_teams", searchTeamsDescription, p.toolSearchTeams),
		mcpReadTool(p, "search_users_in_team", searchUsersInTeamDescription, p.toolSearchUsersInTeam),
