...
func NewMattermostToolProvider(authProvider auth.AuthenticationProvider, logger types.Logger, config types.ServerConfig, accessMode types.AccessMode) *MattermostToolProvider {
