...
The MCP server supports file attachments and uploads for various tools. Files are managed through a dedicated data directory for security and organization.
